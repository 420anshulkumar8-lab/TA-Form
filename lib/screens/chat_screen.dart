...
class _ChatScreenState extends State<ChatScreen>
  ...
  Future<void> _sendMessage(String text,
    ...
    // DEBUG: error ko seedha chat bubble me permanently dikhao
    // (SnackBar gayab ho jaata hai, yeh nahi — scroll karke hamesha dekh sakte ho)
    final aiMsg = ChatMessage(
      role: 'assistant',
      content: response.hasError
